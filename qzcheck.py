...
# ORIGIN_CIPHERS = (
#   'ECDH+AESGCM:DH+AES256:DH+AESGCM:ECDH+AES256:ECDH+AES128:DH+AES:ECDH+HIGH:DH+HIGH:ECDH+3DES:DH+3DES:RSA+AESGCM:RSA+AES:RSA+HIGH:RSA+3DES'
# )
...
# for _ in range(5):
#   s.mount('https://ping.pe/', DESAdapter())
#   resp = s.get('https://ping.pe/144.24.210.85').text
#   if "Just a moment..." not in resp:
#     print(resp)
#   else:
#     print(1)
'''
...
if __name__ == "__main__": 
    ...
    res = session.get("https://ping.pe/") #A Cloudflare protected site
    print(res.content)

    #Context Manager
    with CFSession.cfSession() as session:
        res = session.get("https://ping.pe/")
        print(res.content)
'''
'''
...
headers =     {
    ...
    "x-rapidapi-key": "2c46415117mshc6eddb803ee88cep11a25fjsn8a0f14657efc"
    }

payload =        {
    "url": "https://ping.pe/144.24.210.85"
       }
