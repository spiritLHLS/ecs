...
支持系统：Ubuntu 18+，Debian 8+，centos 7+，Fedora 22+，Almalinux 8.5+, RockyLinux 8+, Arch
...
系统基础信息测试融合了三家还有我自己修补的部分检测(systl、virt、NAT类型检测)，应该是目前最全面的了
...
- 增加echo的-e命令选项的检测，避免部分系统echo命令存在问题
